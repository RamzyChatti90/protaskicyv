# protaskicyv
[![CI Status](https://github.com/<YOUR_GITHUB_USERNAME>/proTaskicyv/actions/workflows/main.yml/badge.svg)](https://github.com/<YOUR_GITHUB_USERNAME>/proTaskicyv/actions/workflows/main.yml)
...
To build the final jar and optimize the protaskicyv application for production, run:
